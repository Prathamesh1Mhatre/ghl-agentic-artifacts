...
<div class="container" style="padding-top: var(--space-8); padding-bottom: var(--space-20);">
  ...
  <nav style="margin-bottom: var(--space-6); font-size: var(--hr-font-size-sm); color: var(--text-muted);">
    ...
    <span style="color: var(--text-default);">Platform</span>
  </nav>
  ...
  <header style="margin-bottom: var(--space-12); padding-bottom: var(--space-6); border-bottom: 1px solid var(--border-default);">
    <div style="display: flex; align-items: center; gap: var(--space-4); margin-bottom: var(--space-4);">
      ...
      <h1 style="font-size: var(--hr-font-size-display-md); font-weight: var(--hr-font-weight-bold); color: var(--text-heading);">Platform Namespace</h1>
    </div>
    <p style="font-size: var(--hr-font-size-xl); color: var(--text-secondary); max-width: 800px;">
      Platform infrastructure, shared components, design system, and core services that power GoHighLevel.
    </p>
  </header>
  ...
  <section>
    ...
    {% assign platform_artifacts = site.pages | where_exp: "page", "page.namespace == 'platform'" | where_exp: "page", "page.layout == 'artifact'" | sort: "date" | reverse %}

    {% if platform_artifacts.size > 0 %}
    ...
    {% else %}
      <p style="text-align: center; padding: var(--space-12); color: var(--text-muted);">
        No artifacts published yet in the Platform namespace.
      </p>
    {% endif %}
  </section>
</div>
